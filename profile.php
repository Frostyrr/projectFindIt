...
// --- Pagination Logic ---
$limit = 6; // Show 6 items per page (2 rows of 3)
        ...
        <div class="profile-top-grid">
            ...
            <aside class="account-settings card">
                ...
                <div class="settings-actions">
                    <button class="action-btn secondary-outline w-full" onclick="alert('Account deletion requires contacting an administrator.');">Delete Account</button>
                        ...
                        <div class="report-card">
                            ...
                            <div class="card-content">
                                ...
                                <div class="profile-card-actions">
                                    ...
                                    <a href="delete.php?id=<?= $row['id'] ?>" class="p-btn delete-btn" onclick="return confirm('Delete this report?');">Delete</a>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
